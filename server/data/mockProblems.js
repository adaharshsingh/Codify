  ...
  },
  {
    ...
    problems: [
      ...
      },
      {
        ...
        difficulty: 'Medium',
        platform: 'Codeforces',
        cfLink: 'https://codeforces.com/problemset/problem/510/C',
        statement:
          'You are given a directed graph with N vertices and M edges. Your task is to find the number of simple cycles in this graph.\n\nA simple cycle is a path that starts and ends at the same vertex without repeating any other vertices.',
        constraints: '• 1 ≤ N ≤ 1000\n• 0 ≤ M ≤ N*(N-1)/2\n• An edge connects two different vertices',
        examples: [
          { input: 'N = 3, edges = [(1,2), (2,3), (3,1)]', output: '1', explanation: 'One cycle: 1→2→3→1' },
          { input: 'N = 4, edges = [(1,2), (2,3), (3,1), (3,4)]', output: '1', explanation: 'One cycle: 1→2→3→1' },
        ],
      },
    ],
  },
